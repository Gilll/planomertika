...
const Request = ({isHistoryPage, newOrder}) => {
    ...
    const [requestForm, setRequestForm] = useState({
        ...
        rooms: {
            hallway: false,
            bedroom: false,
			bedroomWithDressingRoom: false,
			guestBedroom: false,
			guestBedroomWithDressingRoom: false,
			guestWc: false,
			dinningRoom: false,
			guestWcWithShower: false,
            childrensroom: false,
			childrensWithDressingRoom: false,
            kitchen: false,
			kitchenDinningRoom: true,
			kitchenLivingRoom: true,
            bathroom: false,
			bathroomWithBath: false,
			bathroomWithShower: false,
            livingroom: false,
            wardrobe: false,
            cabinet: false,
			сabinetWithBed: false,
			pantry: false,
            advanced: ''
        },
		archived: false,
				...
				if (resp.orderResponseList.length && !newOrder)
				{
					...
					setRequestForm({
						...
						rooms: {
							...
							bedroom: currentRequest.orderPageTwoResponse.isBedroom,
							bedroomWithDressingRoom: currentRequest.orderPageTwoResponse.isBedroomWithDressingRoom,
							guestBedroom: currentRequest.orderPageTwoResponse.isGuestBedroom,
							guestBedroomWithDressingRoom: currentRequest.orderPageTwoResponse.isGuestBedroomWithDressingRoom,
							childrensroom: currentRequest.orderPageTwoResponse.isChildrens,
							childrensWithDressingRoom: currentRequest.orderPageTwoResponse.isChildrensWithDressingRoom,
							kitchen: currentRequest.orderPageTwoResponse.isKitchen,
							kitchenDinningRoom: currentRequest.orderPageTwoResponse.isKitchenDinningRoom,
							kitchenLivingRoom: currentRequest.orderPageTwoResponse.isKitchenLivingRoom,
							bathroom: currentRequest.orderPageTwoResponse.isWc,
							bathroomWithBath: currentRequest.orderPageTwoResponse.isWcWithBath,
							bathroomWithShower: currentRequest.orderPageTwoResponse.isWcWithShower,
							guestWc: currentRequest.orderPageTwoResponse.isGuestWc,
							guestWcWithShower: currentRequest.orderPageTwoResponse.isGuestWcWithShower,
							livingroom: currentRequest.orderPageTwoResponse.isLivingRoom,
							wardrobe: currentRequest.orderPageTwoResponse.isWardrobe,
							cabinet: currentRequest.orderPageTwoResponse.isCabinet,
							сabinetWithBed: currentRequest.orderPageTwoResponse.isCabinetWithBed,
							advanced: currentRequest.orderPageTwoResponse.wish,
							dinningRoom: currentRequest.orderPageTwoResponse.isDinningRoom,
							pantry: currentRequest.orderPageTwoResponse.isPantry
						},
