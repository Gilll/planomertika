...
const Room = () => {
	...
	return (
		<div className="chat-room">
			<div className={dId ? "chat-room__container" : "hidden"}>
					<div className="chat-room__title">
						{roomIsLoading
							...
							:
							<>
								<div className="chat-room__title-name">{user.lastName} {user.firstName}</div>
					...
					<div className="chat-room__input-giga-wrapper">
